...
// 24. let 키워드
// let은 변수를 선언할 때 사용되는데, ES6에서 추가가 되었다.
// {}안에서만 사용이 가능하고,
...
//            card.color // -> undefined 객체에 없는 프로퍼티 호출시
...
//      console.log("toString" in card); // true 상속받은 프로퍼티까지 체크함, 모든 객체는 Object를 상속받음
//    - 프로퍼티 표현하는 예제
...
// 값과 형태가 같아야 할 경우에 ===를 사용한다.
// 보통 같냐?라고 물어볼때는 ==아니라 ===를 사용한다.
// const list = ["apple", "orange", "watermelon"];
// list2 = [].concat(list,"banana"); // list 뒤에 banana 추가시켜서 list2에 대입.
